...
function App() {
  ...
  return (
    <div className="min-h-screen  mx-auto my-auto  bg-food-image bg-center">
      <NavBar onChangePage={setPage}/>

      <div className=' container mx-auto bg-cyan-300 mt-10 min-h-[50%] rounded-2xl'>

       <h1 className='font-bold text-center text-xl font-serif py-3'> Horizon 5-Star Hotel Orders</h1>
